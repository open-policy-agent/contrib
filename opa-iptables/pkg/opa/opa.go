...
func New(opaEndpoint string, auth string) Client {
	...
	return &httpClient{opaEndpoint, auth, client}
}

func (c *httpClient) DoQuery(path string, input interface{}) (data []byte, err error) {
...
func (c *httpClient) do(method, url string, data []byte) ([]byte, error) {
