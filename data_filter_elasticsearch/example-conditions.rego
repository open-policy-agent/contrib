...
# ES  Query: {name:clearance from:9 to:<nil> timeZone: includeLower:false includeUpper:true boost:<nil> queryName: format: relation:}
eval(r, "greater_than", c) {
    r[c.field] > c.value
}
